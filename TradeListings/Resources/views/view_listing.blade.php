...
@section('trade-content')
    ...
    <div class="row">
        <div class="col-lg-6">
            @include('trade_listings::widgets._seeking', ['user' => $listing->user, 'data' => $seekingData, 'listing' => $listing, 'type' => 'seeking'])
        </div>

        <div class="col-lg-6">
            @include('trade_listings::widgets._offer', ['user' => $listing->user, 'data' => $offeringData, 'listing' => $listing, 'type' => 'offering'])
        </div>

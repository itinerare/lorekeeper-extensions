...
@section('trade-title') Create New @endsection
...
{!! Form::open(['url' => 'trades/listings/create']) !!}
    ...
    <div class="mb-3 collapse" id="userSeeking">
        <p>
            Select the items, currencies, and/or other goods or services you're seeking.
            @isset($wishlists)
                You may also select whole item wishlists.
            @endisset
        </p>
        <h3>Items</h3>
        <div class="form-group">
        ...
        @isset($wishlists)
            <h3>Wishlists</h3>
            <div class="form-group">
                {!! Form::label('seeking_wishlists[]', 'Wishlist(s)') !!}
                {!! Form::select('seeking_wishlists[]', $wishlists, null, ['id' => 'wishlistList', 'class' => 'form-control', 'multiple']) !!}
            </div>
        @endisset
        <h3>Other</h3>
        <div class="form-group">

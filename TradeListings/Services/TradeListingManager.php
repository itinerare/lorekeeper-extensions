...
namespace Extensions\TradeListings\Services;
...
class TradeListingManager extends Service {
    ...
    */
     ...
     *
     * @return \App\Models\TradeListing|bool
     */
        ...
        try {
            ...
            if (isset($data['item_ids'])) {
                ...
                foreach ($data['item_ids'] as $id) {
                    if ($id != null) {
                        $item = Item::find($id);
                        if (!$item) {
                            throw new \Exception('One or more of the selected items is invalid.');
                        }
                    }
                }
            ...
            if (isset($data['seeking_currency_ids'])) {
                ...
                foreach ($currencies as $currency) {
                    ...
                    if (!$currency->allow_user_to_user) {

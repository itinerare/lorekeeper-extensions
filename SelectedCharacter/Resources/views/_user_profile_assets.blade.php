<div class="row">
    <div class="col-md-6">
        @include('selectedcharacter::_selected_character', [
            'character' => Extensions\SelectedCharacter\Models\SelectedCharacterUserSettings::find($user->id)->selectedCharacter,
            'user' => $user,
            'fullImage' => config('selectedcharacter.use_full_image'),
        ])
    </div>
